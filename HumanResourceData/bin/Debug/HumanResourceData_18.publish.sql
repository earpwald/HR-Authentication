...
GO
PRINT N'Dropping DF__User__NumLoginAt__20C1E124...';


GO
ALTER TABLE [dbo].[User] DROP CONSTRAINT [DF__User__NumLoginAt__20C1E124];
...
GO
ALTER TABLE [dbo].[User] ALTER COLUMN [NumLoginAttempts] INT NOT NULL;
...
ALTER TABLE [dbo].[User]
    ADD DEFAULT 0 FOR [NumLoginAttempts];
