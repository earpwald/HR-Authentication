...
GO
/*
The column [dbo].[User].[Salt] is being dropped, data loss could occur.
*/
...
USING (VALUES 
        ('janderson','James','Anderson', 'janderson20@hotmail.co.uk', '$2a$10$qjW9TQXKpyZasQYVmwljR.EsRYX2TUrSql1MaGMofOCZY3QNIhL7S', 0), 
        ('jsmith','James','Smith', 'j.smith@hotmail.co.uk', '$2a$10$qjW9TQXKpyZasQYVmwljR.EsRYX2TUrSql1MaGMofOCZY3QNIhL7S', 0)
) 
AS Source (Username, FirstName, LastName, Email, Pass, TwoStepActive) 
