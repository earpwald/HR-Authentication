...
USING (VALUES 
        ('janderson','James','Anderson', 'janderson20@hotmail.co.uk', 'pass', 0, 'salt'), 
        ('jsmith','James','Smith', 'j.smith@hotmail.co.uk', 'pass', 0, 'salt')
) 
AS Source (Username, FirstName, LastName, Email, Pass, TwoStepActive, Salt) 
ON Target.Username = Source.Username 
WHEN NOT MATCHED BY TARGET THEN
INSERT (Username, FirstName, LastName, Email, Pass, TwoStepActive, Salt) 
VALUES (Username, FirstName, LastName, Email, Pass, TwoStepActive, Salt);
GO
