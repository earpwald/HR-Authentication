...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_LoginHistory] ON;
        INSERT INTO [dbo].[tmp_ms_xx_LoginHistory] ([Id], [Username], [LoginAttemptTime], [Successful])
        SELECT   [Id],
                 [Username],
                 [LoginAttemptTime],
                 [Successful]
        FROM     [dbo].[LoginHistory]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_LoginHistory] OFF;
    END
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_User] ([Id], [Username], [FirstName], [LastName], [Email], [Pass], [TwoStepActive])
        SELECT   [Id],
                 [Username],
                 [FirstName],
                 [LastName],
