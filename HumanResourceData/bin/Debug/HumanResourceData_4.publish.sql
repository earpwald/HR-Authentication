...
GO
PRINT N'Creating CK_User_Email...';


GO
ALTER TABLE [dbo].[User]
    ADD CONSTRAINT [CK_User_Email] UNIQUE NONCLUSTERED ([Email] ASC);


GO
PRINT N'Creating CK_User_Username...';


GO
ALTER TABLE [dbo].[User]
    ADD CONSTRAINT [CK_User_Username] UNIQUE NONCLUSTERED ([Username] ASC);
